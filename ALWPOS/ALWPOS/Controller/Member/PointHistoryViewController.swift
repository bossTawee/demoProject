...
class PointHistoryViewController: UIViewController {
    ...
    var unitPointLabel: PaddingLabel = {
        ...
        let width = lb.widthAnchor.constraint(equalToConstant: 150)
        width.isActive = true
        lb.bgLabel("แต้ม/หน่วย", fontSize: 16)
        return lb
    }()
    var totalPointLabel: PaddingLabel = {
        ...
        let width = lb.widthAnchor.constraint(equalToConstant: 150)
        width.isActive = true
        lb.bgLabel("แต้มรวม", fontSize: 16)
        return lb
    }()
    ...
    override func viewDidLoad() {
        ...
        tableView.register(PointHistoryCell.self, forCellReuseIdentifier: cellId)
        setupView()
    ...
    func setupView() {
        ...
        stackView.anchor(top: view1.topAnchor, leading: view1.leadingAnchor,
                         trailing: view1.trailingAnchor, bottom: view1.bottomAnchor)
...
extension PointHistoryViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: cellId, for: indexPath) as! PointHistoryCell
        return cell
    }
